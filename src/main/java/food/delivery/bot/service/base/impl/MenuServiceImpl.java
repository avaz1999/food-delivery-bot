...
public class MenuServiceImpl implements MenuService {
    ...
    @Override
    public List<PartialBotApiMethod<?>> aboutUs(BotUser botUserDTO, CallbackQuery callbackQuery) {
        return List.of();
    }
    ...
    @Override
    public List<PartialBotApiMethod<?>> comment(BotUser botUserDTO, CallbackQuery callbackQuery) {
        return List.of();
    }

    //-------------------SETTING--------------------------
    @Override
    public List<PartialBotApiMethod<?>> settingMenu(BotUser botUserDTO, CallbackQuery callbackQuery) {
        Integer messageId = callbackQuery.getMessage().getMessageId();
        PartialBotApiMethod<?> editMessage = baseService.
                processSettingLanguage(botUserDTO, messageId, baseService, replyMarkupService);
        botUserService.changeState(botUserDTO, State.STATE_SETTING_MENU.name());
    ...
    @Override
    public List<PartialBotApiMethod<?>> settingChangeLangMenu(BotUser botUser, CallbackQuery callbackQuery) {
        String changeLangMessage = CHOOSE_LANGUAGE.getMessage(botUser.getLanguage());
        Integer messageId = callbackQuery.getMessage().getMessageId();
        botUserService.changeState(botUser, State.STATE_SETTING_CHOOSE_LANG.name());
    ...
    @Override
    public List<PartialBotApiMethod<?>> settingChangePhoneMenu(BotUser botUser, CallbackQuery callbackQuery) {
        ...
        botUserService.changeState(botUser, State.STATE_SETTING_PHONE_NUMBER.name());
        return List.of(deleteMessage, sendMessage);
    }

    @Override
    public List<PartialBotApiMethod<?>> settingChangeAddressMenu(BotUser botUser, CallbackQuery callbackQuery) {
        ...
        botUserService.changeState(botUser, State.STATE_SETTING_ADDRESS.name());
        return List.of(deleteMessage, sendLocation);
    }

    @Override
    public List<PartialBotApiMethod<?>> mainMenu(BotUser botUser, CallbackQuery callbackQuery) {
